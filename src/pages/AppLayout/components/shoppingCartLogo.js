...
return(
    ...
    <svg
      ...
      {...props}
      style={{fill:currentThemeMode==="dark"?"#ff9800":"#272727"}}
    >
    ...
    <Typography component="span" color={currentThemeMode==="dark"?"#ff9800":"#fff"} className="shopping-cart-logo-counter" style={{display:"inline-block", paddingBottom:"10px"}}>{cartCounter}</Typography>
    </>
  );
}
